    ...
    <div className="about">
      ...
      <div className="about__container">
        ...
        <div className="about__info info">
          ...
          <div className="info__par"><p>Автобус будет ждать у метро Проспект Просвещения (здесь) за 30 мин. до выезда. Отправление в 15:00. Не опаздывайте!</p>
          <p>Обратный трансфер будет выезжать от ресторана в 23:00.</p>
          </div>
        </div>
      </div>
    </div>
